...
namespace VNSC
{
    public partial class Form_Restore : Form
    {
        ...
        public Form_Restore(string sConfirm2)
        {
            InitializeComponent();
        ...
        public Form_Restore(string sConfirm1, string sConfirm2)
        {
            InitializeComponent();
        ...
        private void LoadPic()
        {
            try
            {
                this.BackgroundImage = Image.FromFile(@"Resources\form_history.jpg");
