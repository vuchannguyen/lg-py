...
namespace VNSC
{
    public partial class UC_NhomTrachVu : UserControl
    {
        private List<NhomTrachVu> list_dto;
        private string sMa;
        private int iRows;
        private int iTotalPage;
        private int iRowsPerPage;

        public UC_NhomTrachVu()
        {
            InitializeComponent();
        }
        ...
        private void UC_NhomTrachVu_Load(object sender, EventArgs e)
        {
            LoadPic();
        ...
        {
            tbSearch.Text = "";
            list_dto = NhomTrachVu_BUS.LayDSNhomTrachVu();
            if (list_dto.Count > 0)
            {
        ...
        {
            list_dto = NhomTrachVu_BUS.TraCuuDSNhomTrachVuTheoTen(sTen);
        ...
        private void pbThem_Click(object sender, EventArgs e)
        {
            ...
            lbTitle.Text = "THÊM NHÓM TRÁCH VỤ";
            lbSelect.Text = "THÊM";
            ...
            if (list_dto.Count > 0)
            {
                tbMa.Text = "D" + SubFunction.ThemMa3So(int.Parse(sMa.Substring(sMa.Length - 3, 3)));
            }
            else
            {
                tbMa.Text = "D001";
        ...
        {
            //
            NhomTrachVu dto = NhomTrachVu_BUS.TraCuuNhomTrachVuTheoMa(lvThongTin.SelectedItems[0].SubItems[0].Text);
            tbMa.Text = dto.Ma;
            tbTen.Text = dto.Ten;
            ...
            lbTitle.Text = "SỬA NHÓM TRÁCH VỤ";
            lbSelect.Text = "SỬA";
        }
