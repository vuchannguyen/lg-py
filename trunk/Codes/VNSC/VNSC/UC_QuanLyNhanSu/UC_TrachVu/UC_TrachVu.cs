...
namespace VNSC
{
    public partial class UC_TrachVu : UserControl
    {
        private List<TrachVu> list_dto;
        ...
        private void LoadPic()
        {
            try
            {
                ...
                pbTitle.Image = Image.FromFile(@"Resources\NhanSu\icon_qlhoso_trachvu_title.png");
        ...
        private void UC_TrachVu_Load(object sender, EventArgs e)
        {
            list_NhomTrachVu = new List<string>();

            if (!LayDSNhomTrachVu_ComboBox(cbNhomTrachVu))
            {
                this.Visible = false;
        ...
        private void NewInfo()
        {
            ...
            if (cbNhomTrachVu.Items.Count > 0)
            {
                cbNhomTrachVu.SelectedIndex = 0;
            }
        }
        ...
        {
            tbSearch.Text = "";
            list_dto = TrachVu_BUS.LayDSTrachVu();
            if (list_dto.Count > 0)
            {
        ...
        {
            list_dto = TrachVu_BUS.TraCuuDSTrachVuTheoTen(sTen);
        ...
        private void pbThem_Click(object sender, EventArgs e)
        {
            ...
            if (list_dto.Count > 0)
            {
                tbMa.Text = "T" + SubFunction.ThemMa3So(int.Parse(sMa.Substring(sMa.Length - 3, 3)));
            }
            else
            {
                tbMa.Text = "T001";
        ...
        private void pbXoa_Click(object sender, EventArgs e)
        {
            ...
            if (frm_Confirm.Yes)
            {
                ...
                {
                    if (!TrachVu_BUS.Delete(lvThongTin.SelectedItems[i].SubItems[0].Text))
                    {
                        Form_Notice frm_Notice = new Form_Notice("Không thể xóa!", "Vẫn còn Hồ sơ có Trách vụ này!", false);
                        break;
                    }
                }
                refreshListView();
        ...
        {
            TrachVu dto = TrachVu_BUS.TraCuuTrachVuTheoMa(lvThongTin.SelectedItems[0].SubItems[0].Text);
            tbMa.Text = dto.Ma;
            cbNhomTrachVu.Text = NhomTrachVu_BUS.TraCuuNhomTrachVuTheoMa(dto.MaNhomTrachVu).Ten;
            tbTen.Text = dto.Ten;
        ...
        private void pbHoanTat_Click(object sender, EventArgs e)
        {
            ...
            {
                TrachVu dto = new TrachVu();
                dto.Ma = tbMa.Text;
                dto.MaNhomTrachVu = list_NhomTrachVu[cbNhomTrachVu.SelectedIndex];
                //dto.MaNhomTrachVu = NhomTrachVu_BUS.TraCuuNhomTrachVuTheoTen(cbNhomTrachVu.Text).Ma;
                dto.Ten = tbTen.Text;
                dto.MoTa = tbMoTa.Text;

                if (TrachVu_BUS.Insert(dto))
                {
                    pnQuanLy.Visible = true;
                    pnSelect.Visible = true;
                    pnInfo.Visible = false;
                ...
                {
                    Form_Notice frm = new Form_Notice("Không thể tạo Trách Vụ!", false);
                }
            }

            if (lbSelect.Text == "SỬA")
            {
                TrachVu dto = TrachVu_BUS.TraCuuTrachVuTheoMa(tbMa.Text);
                dto.MaNhomTrachVu = list_NhomTrachVu[cbNhomTrachVu.SelectedIndex];
                //dto.MaNhomTrachVu = NhomTrachVu_BUS.TraCuuNhomTrachVuTheoTen(cbNhomTrachVu.Text).Ma;
                dto.Ten = tbTen.Text;
                dto.MoTa = tbMoTa.Text;

                if (TrachVu_BUS.UpdateTrachVuInfo(dto))
                {
                    pnQuanLy.Visible = true;
                    pnSelect.Visible = true;
                    pnInfo.Visible = false;
                ...
                {
                    Form_Notice frm = new Form_Notice("Không thể cập nhật Trách Vụ!", false);
                }
            }
        }
