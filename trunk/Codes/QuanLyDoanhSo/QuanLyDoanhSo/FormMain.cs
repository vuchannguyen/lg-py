...
namespace Weedon
{
    public partial class FormMain : Form
    {
        ...
        private bool isMainMenuClickNguonCungCap;
        ...
        private void Init()
        {
            ...
            isMainMenuClickNguonCungCap = false;
        ...
        private void pbNguonCungCap_Click(object sender, EventArgs e)
        {
            if (WarningEditingDialog())
            {
                ...
                CommonFunc.NewControl(pnBody.Controls, ref uc, new UcNguonCungCapIndex());

                Init();
                isMainMenuClickNguonCungCap = true;

                pbNguonCungCap.Image = Image.FromFile(ConstantResource.KHACHHANG_ICON_KHACHHANG_MOUSEOVER);
                lbNguonCungCap.ForeColor = Constant.COLOR_IN_USE;
        ...
        {
            if (!isMainMenuClickNguonCungCap)
            {
                pbNguonCungCap.Image = Image.FromFile(ConstantResource.KHACHHANG_ICON_KHACHHANG);
                lbNguonCungCap.ForeColor = Constant.COLOR_NORMAL;
            }
        ...
        private void pbNhatKyNguyenLieu_Click(object sender, EventArgs e)
        {
            if (WarningEditingDialog())
            {
                ...
                lbNhapHang.ForeColor = Constant.COLOR_IN_USE;
