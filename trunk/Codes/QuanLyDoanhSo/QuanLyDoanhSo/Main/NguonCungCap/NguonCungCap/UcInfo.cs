...
namespace Weedon.NguonCungCap
{
    public partial class UcInfo : UserControl
    {
        ...
        public UcInfo(DTO.NguonCungCap data)
        {
            InitializeComponent();
        ...
        private void InsertData()
        {
            ...
            data.MaSoThue = tbMST.Text;
            data.Email = tbEmail.Text;
            data.GhiChu = tbGhiChu.Text;
            
            if (NguonCungCapBus.Insert(data))
            {
                this.Dispose();
            }
            else
        ...
        private void UpdateData()
        {
            ...
            if (NguonCungCapBus.Update(data))
            {
                this.Dispose();
            }
            else
