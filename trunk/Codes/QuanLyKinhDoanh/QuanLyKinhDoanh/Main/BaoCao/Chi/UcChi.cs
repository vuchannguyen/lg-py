...
namespace QuanLyKinhDoanh.Chi
{
    public partial class UcChi : UserControl
    {
        ...
        private void UcChi_Load(object sender, EventArgs e)
        {
            ...
            RefreshListView(tbSearch.Text, cbFilter.Text, dtpFilter.Value,
            ...
            string sortColumn, string sortOrder, int page)
        {
            ...
            int total = HoaDonBus.GetCountChi(text, timeType, date);
            ...
            List<DTO.HoaDon> listTotal = HoaDonBus.GetListChi(text, timeType, date,
            ...
            List<DTO.HoaDon> list = HoaDonBus.GetListChi(text, timeType, date,
