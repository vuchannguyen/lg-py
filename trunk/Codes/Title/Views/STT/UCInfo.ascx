...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        $("#btnChangePhoto").click(function () {
            var url = "/Common/UploadImage?controller=STT&recordID=" + $('#RecordID').val() + "&saveTo=<%=Constants.IMAGE_PATH %>";
            CRM.popUpWindow(url, '#Photograph', 'Upload Photo');
            return false;
        });
        $("#btnUpload_CV").click(function () {
            var url = "/Common/UploadFile?controller=STT&recordID=" + $('#RecordID').val() + "&saveTo=<%=Constants.CV_PATH %>";
        ...
        $("#btndownload_cv").click(function () {
            ...
            CRM.downLoadFile(file_path, outputname == "" ? "STT's_CV" : outputname + "'s_CV");
            return false;
        });
        $(function () {
        ...
        $("#LaborUnion").click(function () {
            if ($("#LaborUnion").attr("checked") == true) {
                ...
                $("#LaborUnionDate").change(function () {
                    ...
                    $("#LaborUnionDate").rules("add", { checkAge: ["input[name='DOB']"] });
                });
...
<div class="form">
    <div style="width: 1024px; text-align: right;">
        ...
        <input type="button" title="Cancel" onclick="CRM.back();" id="btnCancelTop" class="cancel"
            value="" />
    </div>
    <%
        ...
        else
        {
            ...
            Response.Write(Html.Hidden("empFullName", (emp.FirstName + " " + emp.MiddleName + " " + emp.LastName).Replace(" ", "_")));
                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td class="input last">
                                                <% if (ViewData.Model == null)
                                                   {
                                                       Response.Write(Html.DropDownList("STTStatusId", null, Constants.FIRST_ITEM, new { @style = "width:136px" }));
                                                   }
                                                   else
                                                   {
                                                       ...
                                                       {
                                                           Response.Write(Html.DropDownList("STTStatusId", null, emp.STTStatusId.ToString(), new { @style = "width:136px", @disabled = "disabled" }));
                                            ...
                                            <td class="input">
                                                <% if (ViewData.Model == null)
                                                   ...
                                                   {
                                                       Response.Write(Html.TextBox("Major", emp.Major, new { @style = "width:130px", @maxlength = "255" }));
                                                   }
                                                %>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" class="clrrgh">
                                                ...
                                                <input type="button" id="btnRemoveImage" class="remove_image" style="<%=stylePhoto %>"
                                                    onclick="CRM.msgConfirmBox('Are you sure you want to remove Photo?', 450,'CRM.removeImage(\'<%=Constants.STT_DEFAULT_VALUE %>\')','Remove Photo');"
                                                ...
                                                <input type="button" id="btnRemoveCV" class="remove_cv" style="<%=styleCV %>" value=""
                                                    title="Remove CV" onclick="CRM.msgConfirmBox('Are you sure you want to remove CV?', 450, 'CRM.removeCVFile(\'<%=Constants.STT_DEFAULT_VALUE %>\')','Remove CV');" />
    ...
    <table cellspacing="0" cellpadding="0" border="0" class="gbox" width="1032px" style="border: 1px">
        <tbody>
            <tr>
                <td width="370px" valign="top" style="padding: 0px;">
                    <table cellspacing="0" cellpadding="0" border="0" width="100%" class="profile">
                        <tbody>
                            <tr>
                                <td class="ctbox">
                                ...
                                <td valign="top" class="ccbox">
                                    <table cellspacing="0" cellpadding="0" border="0" width="100%" class="edit">
                                        <tbody>
                                            <tr>
                                                <td class="require label">
                                                    <b>STT ID </b><span style="color: Red">*</span>
                                                </td>
                                                <td class="input">
                                                    <% 
                                                        if (ViewData.Model == null)
                                            ...
                                            <tr>
                                                ...
                                                <td class="input">
                                                    <% if (ViewData.Model == null || (ViewData.Model != null && ViewData["ReActive"] != null))
                                                       {
                                                           Response.Write(Html.TextBox("ExpectedEndDate", "", new { @style = "width:130px" }));
                                                       }
                                                       else
                                                       {
                                                           Response.Write(Html.TextBox("ExpectedEndDate", emp.ExpectedEndDate.HasValue ? emp.ExpectedEndDate.Value.ToString(Constants.DATETIME_FORMAT) : "", new { @style = "width:130px" }));
                                                       }
                                                    %>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <td class="input">
                                                        ...
                                                        %>
                                                        <button type="button" class="icon select" title="Select Work Location" onclick="CRM.popup('/Common/ListSeatCode/', 'Choose Work Location', 850)"></button>
                                            ...
                                            <tr>
                                                ...
                                                <td class="input">
                                                    <% Response.Write(Html.TextBox("Title", Constants.STT_DEFAULT_VALUE, new { @style = "width:130px", @readonly = true })); %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="label">
                                                ...
                                                <td class="input">
                                                    ...
                                                    <% if (ViewData.Model == null)
                                                       {
                                                           Response.Write(Html.TextBox("Project", "", new { @style = "width:130px" }));
                                                       }
                                                       else
                                                       {
                                                           Response.Write(Html.TextBox("Project",!string.IsNullOrEmpty(emp.Project)?emp.Project:"", new { @style = "width:130px" }));
                                                       }
                                                    %>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="input">
                                                    <% if (ViewData.Model == null)
                                                       {
                                                           Response.Write(Html.TextBox("Manager", "", new { @style = "width:130px", @readonly = "readonly" }));
                                                       }
                                                       else
                                                       {
                                                           Response.Write(Html.TextBox("Manager", CommonFunc.GetEmployeeFullName(emp.Employee,
                                                               Constants.FullNameFormat.FirstMiddleLast), new { @style = "width:130px", @readonly = "readonly" }));
                                                       }
                ...
                <td style="padding: 0px;">
                    ...
                    <div class="cbutton" style="text-align: right">
                        <input type="submit" title="Save" class="save" value="" />
                        <input type="button" title="Cancel" onclick="CRM.back();" id="btnCancel" class="cancel"
                            value="" />
                    </div>
                </td>
            </tr>
