...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 <%using (Html.BeginForm("FillData", "PurchaseRequestUS", FormMethod.Post, new { id = "purchaseForm", @class = "form" }))
    {
        ...
        $("#purchaseForm").validate({
            ...
            submitHandler: function (form) {
                    if (indexSubmit == 0) {
                        ...
                        if(resolutionId == 43 || resolutionId == 45)
                        {
        ...
        $("#WFResolutionID").change(function () {
            ...
            if (resolutionId != 0) {
                ...
                if (resolutionId == '<%= Constants.PRUS_RESOLUTION_TO_BE_PROCESSED %>') {
                    ...
                    $.getJSON('/Library/GenericHandle/DropdownListHandler.ashx?ID=' + resolutionId + '&isus=true&Page=PurChaseAssign', function (item) {
                        $.each(item, function () {
                            if (this['ID'] != undefined) {
