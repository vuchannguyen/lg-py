...
<%= SystemLogInfo.MenuName + CommonPageInfo.AppSepChar + SystemLogInfo.ComUserAccess + CommonPageInfo.AppSepChar + CommonPageInfo.AppName%>
</asp:Content>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#ToDate").datepicker();
        jQuery("#list").jqGrid({
            url: '/UserLog/GetListJQGridForPortalUserLog?userAdmin=' + $('#UserAdmin').val()
        ...
        $("#btnRefresh").click(function () {
            window.location = "/UserLog/Refresh/2";
        });

        $('#btnClearLog').click(function () {
            window.location.href = 'javascript:CRM.popup("../UserLog/ClearLog?type=PortalAccess","Clear Logs", 400);';
        });
        ...
        $("#btnFilter").click(function () {
            ...
            if (isValid) {
                $('#list').setGridParam({ url: '/UserLog/GetListJQGridForPortalUserLog?userAdmin=' + $('#UserAdmin').val()
                     + '&dateFrom=' + $('#FromDate').val() + '&dateTo=' + $('#ToDate').val()
                }).trigger('reloadGrid');
            }
        });
