...
<%using (Html.BeginForm("PurchasingConFirm", "PurchaseRequest", FormMethod.Post, new { id = "purchaseForm", @class = "form" }))
  { %>
...
<%=PurchaseRequestPageInfo.FuncPurchasingConfirm + CommonPageInfo.AppSepChar + PurchaseRequestPageInfo.ComName + CommonPageInfo.AppSepChar + CommonPageInfo.AppName%>
</asp:Content>
...
<% PurchaseRequest obj = (PurchaseRequest)ViewData.Model;
   ...
   value = CommonFunc.GetCurrentMenu(Request.RawUrl)+" <a href='/PurchaseRequest/Detail/" + obj.ID + "'>" + Constants.PR_REQUEST_PREFIX + obj.ID + "</a> » " + PurchaseRequestPageInfo.FuncPurchasingConfirm;
    %>
    <%= value%>
</asp:Content>
