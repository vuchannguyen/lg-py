        ...
        <td valign="top" class="ccbox">
            <table cellspacing="0" cellpadding="0" border="0" width="1050px" class="edit">
                ...
                <tr>
                    ...
                    <td class="input" style="width: 190px">
                        <b>
                            <% if (ViewData.Model == null)
                               {
                                   //Response.Write(Html.TextBox("RequestDate", DateTime.Now.ToString(Constants.DATETIME_FORMAT), new { @maxlength = "10", @style = "width:140px" }));
                               ...
                               {
                                   //Response.Write(Html.TextBox("RequestDate", obj.RequestDate.ToString(Constants.DATETIME_FORMAT), new { @maxlength = "10", @style = "width:140px" }));
                ...
                <tr>
                    ...
                    <td class="input">
                        <%=Html.TextBox("VendorName", ViewData.Model != null ? obj.VendorName : "", new { @maxlength = "100", @style = "width:160px" })%>
                    </td>
                </tr>
                <tr>
                    <td class="label" style="width: 150px;">
                    ...
                    <td class="input">
                        <%=Html.TextBox("VendorPhone", ViewData.Model != null ? obj.VendorPhone : "", new { @maxlength = "50", @style = "width:160px" })%>
                    </td>
                </tr>
                <tr>
                    <td class="label" style="width: 150px;">
                    ...
                    <td class="input">
                        <%=Html.TextBox("VendorEmail", ViewData.Model != null ? obj.VendorEmail : "", new { @maxlength = "100", @style = "width:160px" })%>
                    </td>
                </tr>
                <tr>
                    <td class="label" style="width: 120px;">
                    ...
                    <td class="input" style="vertical-align: top">
                        <%=Html.TextBox("VendorAddress", ViewData.Model != null ? obj.VendorAddress : "", new { @style = "width:160px;", @maxlength = "200" })%>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                ...
                <tr>
                    <td colspan="2" align="left">
                        <table width="420px">
                            <tr>
                                ...
                                <%--<td class="required" style="width:105x;">
                                   Payment Method <span style="color:Red">*</span>
                                </td>
                                <td style="width:60px">
                                    <% if (ViewData.Model == null)
                                       {
                                           Response.Write("<label hidValue='Cash' for=cash>" + Html.RadioButton("chk_Payment", "1", false, new { id = "cash"}) + " Cash</label>");
                                       }
                                       else
                                       {
                                           Response.Write("<label hidValue='Cash' for=cash>" + Html.RadioButton("chk_Payment", "1", obj.PaymentID == Constants.TYPE_PAYMENT_CASH ? true : false, new { id = "cash" }) + " Cash</label>");
                                ...
                                <td style="width:80px">
                                    <% if (ViewData.Model == null)
                                       {                                           
                                           Response.Write("<label hidValue='Tranfer' for=tranfer>" + Html.RadioButton("chk_Payment", "2", false, new { id = "tranfer" }) + " Transfer</label>");
                                           Response.Write(Html.Hidden("txt_Payment", ""));
                                       }
                                       else
                                       {                                           
                                           Response.Write("<label hidValue='Tranfer'  for=tranfer>" + Html.RadioButton("chk_Payment", "2", obj.PaymentID == Constants.TYPE_PAYMENT_TRANFER ? true : false, new { id = "tranfer" }) + " Tranfer</label>");
                                           Response.Write(Html.Hidden("txt_Payment", obj.PaymentID));
                                       }    
                    ...
                    <td colspan="2" align="left">
                        <table  style="float: right;" width="100%">
                            <tr>
                                <%--<td align=right class="required" style="width:80px">
                                    Money Type <span style="color:Red">*</span>
                                </td>--%>
                                <%--<td align=right style="width:60px;margin:0px;padding:0">
                                    <% if (ViewData.Model == null)
                                       {
                                           Response.Write("<label hidValue='USD'>" + Html.RadioButton("chk_MoneyTypeGroup", "1", false) + " USD</label>&nbsp;");
                                       }
                                       else
                                       {
                                ...
                                <td align=right style="width:60px;margin:0px;padding:0">
                                    <% if (ViewData.Model == null)
                                       {
                                           Response.Write("<label hidValue='VND'>" + Html.RadioButton("chk_MoneyTypeGroup", "2", true) + " VND</label>&nbsp;");
                                       }
                                       else
                                       {
                                    ...
                                    <%
                                        if (ViewData.Model == null)
                                        {
                                            Response.Write(Html.TextBox("SaleTaxValue", "0",
                                                new { @maxlength = "14", @style = "width:130px" }));
                                        }
                                        else
                                        {
                                            ...
                                            {
                                                Response.Write(Html.TextBox("SaleTaxValue", "0",
                                                    new { @disabled = "disabled", @maxlength = "14", @style = "width:130px" }));
                                            }
                                            else
                                            {
...
//        $("#Total").val(value + " " + prefix);
    ...
    $(document).ready(function () {
        ...
        $("input[name='chk_Payment']").change(function () {
            var value = $("input[name='chk_Payment']:checked").val();
            if (value != "") {
                $("#txt_Payment").val(value);
                $("span[htmlfor=txt_Payment]").remove();
            }
        });
        ...
        $("#WFResolutionID").change(function () {
            ...
            if (resolutionId != 0) {
                ...
                if (resolutionId != '<%= Constants.PR_RESOLUTION_CANCEL %>') {
                    ...
                    $.getJSON('/Library/GenericHandle/DropdownListHandler.ashx?ID=' + resolutionId +
                        '&Page=PurChaseAssign' + sParam, function (item) {
                            $.each(item, function () {
                                if (this['ID'] != undefined) {
