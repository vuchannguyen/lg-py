...
<asp:Content ID="Content1" ContentPlaceHolderID="PageTitle" runat="server">
    <%= TrainingCenterPageInfo.FuncEngDetail + CommonPageInfo.AppSepChar + CommonPageInfo.AppName%> 
</asp:Content>
    ...
    <div style="width: 1024px">
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
                ...
                <td align="right">
                   <a href="javascript:void(0)" onclick="CRM.popup('/TrainingCenterAdmin/EditClass/<%=request.ID %>?page=EngClassDetail', 'Edit English Class - <%=request.ClassId  %>', '700')">Edit</a>
     ...
     <div style="width:1024px">
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
                ...
                <td align="right">
                   <a href="javascript:void(0)" onclick="CRM.popup('/TrainingCenterAdmin/UpdateAttendees/<%=request.ID %>?page=EngClassDetail', 'Update Attendees - <%=request.ClassId %>', '800')">Update Attendees</a>
                </td>
            </tr>
        </table>
        ...
        $(document).ready(function () {
            ...
            $('#btnFirst').click(function () {
                ...
                if (className != "first first_off") {
                    window.location = "/TrainingCenterAdmin/EngClassDetail/" + $('#btnFirst').val();
                }
            });
            $('#btnPre').click(function () {
                ...
                if (className != "prev prev_off") {
                    window.location = "/TrainingCenterAdmin/EngClassDetail/" + $('#btnPre').val();
                }
            });
            $('#btnNext').click(function () {
                ...
                if (className != "next next_off") {
                    window.location = "/TrainingCenterAdmin/EngClassDetail/" + $('#btnNext').val();
                }
            });
            $('#btnLast').click(function () {
                ...
                if (className != "last last_off") {
                    window.location = "/TrainingCenterAdmin/EngClassDetail/" + $('#btnLast').val();
                }
            });
            /*---------------------*/        
        });
...
<asp:Content ID="Content4" ContentPlaceHolderID="FunctionTitle" runat="server">
    <% Training_Class request = (Training_Class)ViewData.Model;
       ...
       funcTitle = CommonFunc.GetCurrentMenu(Request.RawUrl) + TrainingCenterPageInfo.FuncClasses + CommonPageInfo.AppDetailSepChar +
           "<a href='/TrainingCenterAdmin/EnglishClass'>" + TrainingCenterPageInfo.FuncChildEng + "</a> » " + request.ClassId;
    %>
    <%= funcTitle%>
</asp:Content>
