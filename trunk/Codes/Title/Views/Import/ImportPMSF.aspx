...
<fieldset>
        ...
        <form id="employeeForm" class="form" action="<%= Url.Action("ImportPMSF", "Import")%>" method="post"
        ...
        <div>
            <table class="edit">
                ...
                <tr>
                    ...
                    <td class="input">
                        <input type="text" name="startRow" style="width:50px"/>(3)
                    </td>
                    <td class="label">End Row</td>
                    <td class="input">
                        <input type="text" name="endRow" style="width:50px"/>(367)
                    </td>
