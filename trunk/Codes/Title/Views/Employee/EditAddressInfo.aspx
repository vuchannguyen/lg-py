...
<%using (Html.BeginForm("EditAddressInfo", "Employee", FormMethod.Post, new { @id = "editForm", @class = "form" }))
  { %>
<% Employee emp = (Employee)ViewData.Model;%>
<table cellspacing="0" cellpadding="0" border="0" width="100%" class="edit">
    <tbody>
        <tr>
            <td class="row_detail_label_left">
        ...
        <tr>
            <td class="input">
                ...
                <%if (!string.IsNullOrEmpty(emp.PermanentCityProvince))
                  {
                      Response.Write(Html.TextBox("PermanentCityProvince", emp.PermanentCityProvince, new { @style = "width:91px", @maxlength = "30" }));
                  }
                  else
                  {
                      Response.Write(Html.TextBox("PermanentCityProvince", Constants.CITYPROVINCE, new { @style = "width:91px", @maxlength = "30", @onfocus = "ShowOnFocus(this,'" + Constants.CITYPROVINCE + "')", @onblur = "ShowOnBlur(this,'" + Constants.CITYPROVINCE + "')" }));
                  }%>
                <span class="fsep"></span>
        ...
        <tr>
            <td class="input">
                ...
                <% if (ViewData.Model == null)
                   {
                       Response.Write(Html.TextBox("PermanentCityProvince", Constants.VN_CITYPROVINCE, new { @style = "width:91px", @maxlength = "30", @onfocus = "ShowOnFocus(this,'" + Constants.VN_CITYPROVINCE + "')", @onblur = "ShowOnBlur(this,'" + Constants.VN_CITYPROVINCE + "')" }));
                   }
                   else
                   {
                       if (!string.IsNullOrEmpty(emp.VnPermanentCityProvince))
                       {
                           Response.Write(Html.TextBox("VnPermanentCityProvince", emp.VnPermanentCityProvince, new { @style = "width:91px", @maxlength = "30" }));
                       }
                       else
                       {
                           Response.Write(Html.TextBox("VnPermanentCityProvince", Constants.VN_CITYPROVINCE, new { @style = "width:91px", @maxlength = "30", @onfocus = "ShowOnFocus(this,'" + Constants.VN_CITYPROVINCE + "')", @onblur = "ShowOnBlur(this,'" + Constants.VN_CITYPROVINCE + "')" }));
                       }
                   }
                %>
                <span class="fsep"></span>
        ...
        <tr>
            <td class="input">
                ...
                <%if (!string.IsNullOrEmpty(emp.TempCityProvince))
                  {
                      Response.Write(Html.TextBox("TempCityProvince", emp.TempCityProvince, new { @style = "width:91px", @maxlength = "30" }));
                  }
                  else
                  {
                      Response.Write(Html.TextBox("TempCityProvince", Constants.CITYPROVINCE, new { @style = "width:91px", @maxlength = "30", @onfocus = "ShowOnFocus(this,'" + Constants.CITYPROVINCE + "')", @onblur = "ShowOnBlur(this,'" + Constants.CITYPROVINCE + "')" }));
                  } %>
                <span class="fsep"></span>
        ...
        <tr>
            <td class="input">
                ...
                <% if (ViewData.Model == null)
                   {
                       Response.Write(Html.TextBox("VnTempCityProvince", Constants.VN_CITYPROVINCE, new { @style = "width:91px", @maxlength = "30", @onfocus = "ShowOnFocus(this,'" + Constants.VN_CITYPROVINCE + "')", @onblur = "ShowOnBlur(this,'" + Constants.VN_CITYPROVINCE + "')" }));
                   }
                   else
                   {
                       if (!string.IsNullOrEmpty(emp.VnTempCityProvince))
                       {
                           Response.Write(Html.TextBox("VnTempCityProvince", emp.VnTempCityProvince, new { @style = "width:91px", @maxlength = "30" }));
                       }
                       else
                       {
                           Response.Write(Html.TextBox("VnTempCityProvince", Constants.VN_CITYPROVINCE, new { @style = "width:91px", @maxlength = "30", @onfocus = "ShowOnFocus(this,'" + Constants.VN_CITYPROVINCE + "')", @onblur = "ShowOnBlur(this,'" + Constants.VN_CITYPROVINCE + "')" }));
        ...
        <tr>
            <td align="center" valign="middle" class="cbutton">
