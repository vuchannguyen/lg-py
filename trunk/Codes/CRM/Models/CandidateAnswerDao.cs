...
namespace CRM.Models
{
    ...
    {
        public LOT_CandidateAnswer GetItemByID(long id)
        {
            return dbContext.LOT_CandidateAnswers.Where(p => (p.ID == id)).FirstOrDefault<LOT_CandidateAnswer>();
        }

        public LOT_CandidateAnswer GetByCandidateExamID(long id)
        {
            return dbContext.LOT_CandidateAnswers.Where(p => (p.CandidateExamID == id)).FirstOrDefault<LOT_CandidateAnswer>();
        }
        public List<LOT_CandidateAnswer> GetMultipleChoicesListByCandidateExamIDAndExamQuestionSectionID(long candidateExamID, int examQuestionSectionID)
        {
            return dbContext.LOT_CandidateAnswers.Where(p => (p.CandidateExamID == candidateExamID) && (p.ExamQuestionSectionID == examQuestionSectionID) && (p.LOT_Question.LOT_Section.IsMultipleChoice == true)).ToList<LOT_CandidateAnswer>();
        }

        public bool GetCandidateAnswerQuestionAssignedStatus(int questionId)
        {
            int count = dbContext.LOT_CandidateAnswers.Where(p => p.QuestionID == questionId && p.LOT_Question.DeleteFlag == false).Count();
        ...
        /// <returns></returns>
        public LOT_CandidateAnswer GetByCandidateExamIDAndQuestionID(long candidateExamID, int questionID)
        {
        ...
        /// <returns></returns>
        public List<LOT_CandidateAnswer> GetCandidateExamIDAndExamQuestionSectionID(long candidateExamID, int examQuestionSectionID)
        {
        ...
        /// <param name="examQuestionSectionID"></param>
        /// <returns></returns>
        public List<sp_GetCandidateAnswerListResult> GetCandidateAnswer(long candidateExamID, int examQuestionSectionID)
        {
        ...
        /// <param name="candidateExamID"></param>
        /// <returns></returns>
        public int GetMaxWritingMark(long candidateExamID, int sectionID)
        {
