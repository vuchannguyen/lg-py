...
namespace Library
{
    class Constant
    {
        ...
        public const string DEFAULT_DB_NAME = "Weedon";
        ...
        public const string DEFAULT_USER_ADMIN_NAME = "admin";
        public const string DEFAULT_USER_ADMIN_PASSWORD = "admin";
        ...
        public const string DEFAULT_DATE_FORMAT_EXPORT = "dd-MM-yyyy";
        ...
        public const string DEFAULT_FORMAT_PERCENT = "0" + Constant.SYMBOL_DOT + "##";
        ...
        public const string DEFAULT_TYPE_EXPORT_NGUYENLIEU = "NguyenLieu";
        public const string DEFAULT_SHEET_NAME_EXPORT_NGUYENLIEU = "Nguyên Liệu";

        public const string IS_SOLD = "Is Sold";
        public const string APPROVED = "Duyệt";
        public const string NOT_APPROVED = "Chưa xác thực";
        public const string NaN = "Không sử dụng";
        public const string INFINITY = "Vô lý";
        ...
        public const string TOOLTIP_NGUYENLIEU = "Quản lý Nguyên liệu và Định lượng";
        public const string TOOLTIP_NKNL = "Nhật ký nguyên liệu";
        public const string TOOLTIP_DOANHTHU = "Tra cứu doanh thu";
        public const string TOOLTIP_SETTING = "Cấu hình chức năng";
        ...
        /// </summary>
        public const string TOOLTIP_DETAIL_NHACUNGCAP = "Tên: {0}\n" +
            "Địa chỉ: {1}\n" +
            "Điện thoại: {2}\n" +
            "Fax: {3}\n" +
            "Email: {4}\n";
        ...
        public const int ID_GROUP_MANAGER = 2;
        public const int ID_GROUP_STAFF = 3;
        ...
        public const string CAPTION_INFORMATION = "INFORMATION";
        public const string CAPTION_CONFIRMATION = "CONFIRMATION";
        ...
        public const string MESSAGE_INSERT_ERROR_DUPLICATED = "Quá trình nhập dữ liệu mới thất bại!" + MESSAGE_NEW_LINE + "Vui lòng kiểm tra \"{0}\" đã tồn tại.";
        ...
        public const string MESSAGE_CONFIRM_DELETE_COMPONENT = "Xóa nguyên liệu?";
        ...
        public const string MESSAGE_ERROR_DUPLICATED = "Dữ liệu đã bị trùng!";
        ...
        public const string SEARCH_NGUYENLIEU_TIP = "Mã NL - Tên - Mô tả";
