...
namespace CRM.Models
{
    ...
    public class ExamQuestionSectionQuestionDAO : BaseDao
    {
        ...
        public bool GetQuestionSectionQuestionAssignedStatus(int questionId)
        {
            int count = dbContext.LOT_ExamQuestion_Section_Questions.Where(p => p.QuestionID == questionId && p.LOT_Question.DeleteFlag == false).Count();
