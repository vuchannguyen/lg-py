...
namespace CRM.Models
{
    public class JobTitleLevelDao : BaseDao
    {
        ...
        //Old -> run DropdownListHandler -> Employee
        ...
        //Tuc 13-12-11
        public List<JobTitleLevel> GetJobTitleListByJobTitleId(int jobTitleId)
        {
            return dbContext.JobTitleLevels.Where(p => p.JobTitle != null && p.JobTitle.JobTitleId == jobTitleId
                && p.DeleteFlag == false).ToList<JobTitleLevel>();
        }
