...
namespace CRM.Controllers
{
    public class CommonController : BaseController
    {
                ...
                rows = (
                    ...
                    select new
                    {
                        ...
                        cell = new string[] {
                             ...
                             //HttpUtility.HtmlEncode(m.ID.ToString()),
                             CommonFunc.Link(m.ID.ToString(), "javascript:ChooseCertificationID('" + m.Name + "', " + m.ID + ");", m.ID.ToString(), false),
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public ActionResult PTODetailTooltip(string id)
        {
            ...
            string startdate, string enddate, string requestor)
        {
            ...
            List<sp_SR_GetServiceRequest4AdminResult> empList = new ServiceRequestDao().GetList4Admin(title, subcat, categoryId, statusId, assignName, fromDate, toDate, requestUser);
            ...
            List<sp_SR_GetServiceRequest4AdminResult> finalList = new ServiceRequestDao().SortAdmin(empList, sortColumn, sortOrder)
                                 .Skip((currentPage - 1) * rowCount)
