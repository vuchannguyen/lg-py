...
<%@ Register Src="PerformanceReviewForm/UCPREngineerService.ascx" TagName="UCPRRnD1" TagPrefix="uc1" %>     
    
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <%using (Html.BeginForm("PerformanceReviewManager", "Eform", FormMethod.Post, new { @id = "editForm", @class = "form" })) %>
        <% { %>
    <div class="form" style="height:600px;overflow-x:scroll;">
