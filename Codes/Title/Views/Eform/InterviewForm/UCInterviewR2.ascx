...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#editForm").validate({
            ...
            rules: {
                TextBox13: { required: true, checkDate: true },
                TextBox14: { required: true },
                TextBox1: { validateChecked: ["RadioButton6"] },
                TextBox2: { validateChecked: ["RadioButton8"] },
                TextBox3: { validateChecked: ["RadioButton10"] },
                TextBox4: { validateChecked: ["RadioButton12"] },
                TextBox5: { validateChecked: ["RadioButton14"] },
                TextBox6: { validateChecked: ["RadioButton16"] },
                TextBox7: { validateChecked: ["RadioButton18"] },
                TextBox8: { validateChecked: ["RadioButton20"] }
            }
        });
    });
</script>
...
<%=Html.Hidden("Hidden1",ViewData["eform"]==null?"":ViewData["eform"].ToString())%>
    ...
    <table cellspacing="0" cellpadding="0" border="0" class="grid">
        ...
        <tr>
            <td align="center" colspan="14">
                <strong style="font-size: 10pt">2<sup>nd</sup> Round-Technicall Professional interview: </strong>(For
                HR Dept)<br />
        ...
        <tr>
            ...
            <td class="title">
                13. <%=Html.TextBox("TextBox1", CommonFunc.GetTextBoxValue("TextBox1", eFormDetailList), new { @style = "width:150px", maxlength = "50" })%> 
            </td>
            <td align="center">
        ...
        <tr>
            ...
            <td class="title">
                14. <%=Html.TextBox("TextBox2", CommonFunc.GetTextBoxValue("TextBox2", eFormDetailList), new { @style = "width:150px", maxlength = "50" })%> 
            </td>
            <td align="center">
        ...
        <tr>
            ...
            <td class="title">
                15. <%=Html.TextBox("TextBox3", CommonFunc.GetTextBoxValue("TextBox3", eFormDetailList), new { @style = "width:150px", maxlength = "50" })%>
            </td>
            <td align="center">
        ...
        <tr>
            ...
            <td class="title">
                16. <%=Html.TextBox("TextBox4", CommonFunc.GetTextBoxValue("TextBox4", eFormDetailList), new { @style = "width:150px", maxlength = "50" })%>
            </td>
            <td align="center">
        ...
        <tr>
            ...
            <td class="title">
                17. <%=Html.TextBox("TextBox5", CommonFunc.GetTextBoxValue("TextBox5", eFormDetailList), new { @style = "width:150px", maxlength = "50" })%>
            </td>
            <td align="center">
        ...
        <tr>
            ...
            <td class="title">
                18. <%=Html.TextBox("TextBox6", CommonFunc.GetTextBoxValue("TextBox6", eFormDetailList), new { @Style = "width:150px", maxlength = "50" })%>
             </td>
            <td align="center">
        ...
        <tr>
            ...
            <td class="title">
                19. <%=Html.TextBox("TextBox7", CommonFunc.GetTextBoxValue("TextBox7", eFormDetailList), new { @Style = "width:150px", maxlength = "50" })%>
            </td>
            <td align="center">
        ...
        <tr>
            ...
            <td class="title">
                20. <%=Html.TextBox("TextBox8", CommonFunc.GetTextBoxValue("TextBox8", eFormDetailList), new { @Style = "width:150px", maxlength = "50" })%>
            </td>
            <td align="center">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="edit">
            ...
            <tr>
                ...
                <td class="input">
                    <%
                        string insertDate=CommonFunc.GetTextBoxValue("TextBox13", eFormDetailList);
                    %>
                    <%=Html.TextBox("TextBox13", insertDate == "" ? (interview != null ? interview.InterviewDate.Value.ToString(Constants.DATETIME_FORMAT) : DateTime.Now.ToShortDateString()) : insertDate, new { @style = "width:100px", maxlength = "10" })%>
            </td>
            </tr>
            <tr class="last">
                <td class="label required">
                ...
                <td class="input">
                    <%string user = CommonFunc.GetTextBoxValue("TextBox14", eFormDetailList);%>
                    <%=Html.TextBox("TextBox14", user == "" ? (interview != null ? interview.Pic : (string)ViewData["user"]) : user, new { @style = "width:150px", maxlength = "50" })%>
                </td>
            </tr>
      </table>
