    ...
    function printSpecial() {
        if (document.getElementById != null) {
            ...
            if (jhtml.length != 0) {
                ...
                spanrCheck = $(jhtml).find('span.rcheck');
                $(spanrCheck).each(function () {
                    $(this).parent().append("<img src='/Content/Images/ExtraIcons/tick.png' alt='' />");
        ...
        <tr>
            <td>
                <table width="100%">
                    <tr>
                        <td style="padding-left: 10px">
                            <strong>Date:&nbsp;&nbsp;<%=CommonFunc.GetTextBoxValue("TextBox14", eFormDetailList)%></strong>
                        </td>
                        <td style="padding-right: 10px;" align="right">
                            <strong>Interviewed by:&nbsp;&nbsp;<%=CommonFunc.GetTextBoxValue("TextBox15", eFormDetailList)%></strong>
                        </td>
                    </tr>
                </table>
            </td>
