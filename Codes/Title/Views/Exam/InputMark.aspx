        ...
        $("#ExamForm").validate({
            ...
            rules: {
                WritingMark: {                    
                    integer: true,
                    min:0,
                    max:<%= ViewData[CommonDataKey.CTL_MAX_WRITING_MARK]%>
                },
                WritingComment: {
                    maxlength: 255
                }
...
<%using (Html.BeginForm("InputMark", "Exam", FormMethod.Post, new { id = "ExamForm", @class = "form" }))
  { %>  
  <div class="edit">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td class="label"></td>
        <td colspan="" class="label required" style="text-align:left;">
            Please choose one of the two following questions.  
        </td>
    </tr>
    ...
    %>
    <tr>
        <td width="200" class="label">Topic <%= (i+1) %></td>
        <td class="input">
    ...
    <tr>
        ...
        <td valign="bottom" class="input">
            <input name="WritingMark" type="text" style="width: 50px; text-align: right;" maxlength="3" value='<%= ViewData[CommonDataKey.CTL_WRITING_MARK] %>'/>
            /<%= ViewData[CommonDataKey.CTL_MAX_WRITING_MARK]%></td>
    </tr>
    <tr>
    <td class="label">Comment    
    </td>
    <td class="input">
        <textarea name="WritingComment" cols="20" rows="4" style="height:75px;width: 460px;"><%= ViewData[CommonDataKey.CTL_WRITING_COMMENT]%></textarea></td>
    </tr>
    <tr>        
