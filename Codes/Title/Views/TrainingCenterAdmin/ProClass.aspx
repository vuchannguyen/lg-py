...
<%=TrainingCenterPageInfo.ComName + CommonPageInfo.AppSepChar + TrainingCenterPageInfo.FuncProfessionalTraining + CommonPageInfo.AppSepChar + CommonPageInfo.AppName%>
</asp:Content>

<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server">
 <script type="text/javascript">
     function GetListTargetUrl() {
         var url = '/TrainingCenterAdmin/GetListJQGrid/?text=' + encodeURIComponent($("#txtKeyword").val())
                    + '&Course=' + $('#Course').val() + '&Type=' + $('#Type').val() + '&Status=' + $('#Status').val()
                    + '&Intructor=' + $('#Intructor').val();
         return url;
     }
     $(document).ready(function () {
         $("#btnExport").click(function () {
             window.location = "/TrainingCenterAdmin/Export";
         });
         $("#btnRefresh").click(function () {
             window.location = "/TrainingCenterAdmin/Refresh";
         });
         $("#btnDelete").click(function () {
             CRM.deleteList('#list', 'RealID', '/TrainingCenterAdmin/DeleteListProClass');
         });
         $("#btnAddNew").click(function () {
             CRM.popup("/TrainingCenterAdmin/CreateClass?type=<%=Constants.TRAINING_CENTER_COURSE_TYPE_PRO_SKILL%>", "Create Professional Class", "700");
         });
         CRM.onEnterKeyword();
         ...
         jQuery("#list").jqGrid({
             ...
             datatype: 'json',
             mtype: 'GET',
             colNames: ['#', 'RealID', 'Class ID', 'Course Name', 'Type', 'Status', 'Duration', 'Start Date', 'Instructors', '# of Attendees', 'Objectives', 'Action'],
             colModel: [
                 ...
                 { name: 'RealID', index: 'RealID', align: "center", width: 15, sortable: false, hidden: true },
                  ...
                  { name: 'Type', index: 'Type', align: "center", width: 40, sortable: true },
                  ...
                  { name: 'Duration', index: 'Duration', align: "center", width: 40, sortable: true },
                   { name: 'StartDate', index: 'StartDate', align: "center", width: 40, sortable: true },
