...
<%
    ...
    if (course == null)
    {
        Response.Write(Html.Hidden("TypeOfCourse", Constants.TRAINING_CENTER_COURSE_TYPE_ENGLISH));
    }
    else
    {
...
<table width="100%" class="edit">
    ...
    <tr>
        ...
        <td class="input" colspan ="4">
            <%=Html.TextArea("Objectives", new { @style="width:93%; height:50px"})%>
        </td>
    </tr>
    <tr>
        <td class="label" style="vertical-align:top">Registration Requirements</td>
        <td class="input" colspan ="4">
            <%=Html.TextArea("Requirements", new { @style = "width:93%; height:50px" })%>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="input" colspan ="4">
            <%=Html.TextArea("Notes", new { @style = "width:93%; height:50px" })%>
        </td>
    </tr>
    <tr>
...
//            },
//            CRM.format(E0030, "ID") + 
//                "</br>Only allow: number (0-9), alphabet (a-Z), underline (_) and dash (-)</br>" +
//                "Ex: 1-Xyz_2"
//        );
//        if ('<%=ViewData.Model%>' == '') {
...
//        }
        $("#frmCourse").validate({
            ...
            rules: {
                ...
                txtKeyTrainers: { maxlength: '<%=CommonFunc.GetLengthLimit(newCourse, "KeyTrainers")%>' },
