...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <%= TempData["Message"]%>
    <br />
    <%using (Html.BeginForm("ToSTT", "Interview", FormMethod.Post, new { id = "addSTT" }))
      {%>
    ...
    <div class="form">
        <div style="width: 1024px; text-align: right;">
            ...
            <input type="button" title="Cancel" onclick="javascript:window.location = '/Interview';"
                id="btnCancelTop" class="cancel" value="" />
        </div>
        <%
                                    ...
                                    <td valign="top" width="100%" style="padding: 0px;">
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td class="input last">
                                                    <% 
                                                        Response.Write(Html.DropDownList("STTStatusId", ViewData["EmpStatusId"] as SelectList, Constants.FIRST_ITEM, new { @style = "width:136px" }));
                ...
                <tr>
                                ...
                                <tr>
                                    <td valign="top" class="ccbox">
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%" class="edit">
                                            <tbody>
                                                <tr>
                                                    <td class="require label" style="width: 115px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="input">
                                                        ...
                                                        <button class="icon remove" title="Remove JR" onclick="CRM.clearJR('#JR','#JRApproval'); return false;">
                                                        </button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="require label" >
                                                        <b>Expected End Date </b><span style="color: Red">*</span>
                                                    </td>
                                                    <td class="input">
                                                        <% 
                                               ...
                                               <tr>
                                                    ...
                                                    <td class="input">
                                                        <%= Html.TextBox("Project","", new { @style = "width:130px", @maxlength = "100" })%>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="label">
                    ...
                    <td style="padding: 0px;">
                        ...
                        <div class="cbutton" style="text-align: right">
                            <input type="submit" title="Save" class="save" value="" />
                            <input type="button" title="Cancel" onclick="javascript:window.location = '/Interview';"
                                id="btnCancel" class="cancel" value="" />
                        </div>
                    </td>
                </tr>
            </tbody>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageTitle" runat="server">
    <%=HiringCenterPageInfo.MenuName + CommonPageInfo.AppSepChar +HiringCenterPageInfo.FuncTransferToSTT + CommonPageInfo.AppSepChar + CommonPageInfo.AppName%>
</asp:Content>
        ...
        $(document).ready(function () {
            ...
            $("#addSTT").validate({
                ...
                rules: {
                    ...
                    ExpectedEndDate: { required: true, checkDate: true, compareDate: ["#addSTT input[name='Startdate']", "get", "Expected End Date", "Start Date"] },
                    MarriedStatus: { required: true },
                    TitleId: { required: true },
                    DepartmentId: { required: true },
                    EmpStatusId: { required: true },
                    IssueDate: { required: true, checkDate: true, checkAgeIssue: ["#addSTT input[name='DOB']"] },
                    DOB: { required: true, checkDate: true, checkBirthDate: true },
                    Startdate: { required: true, checkDate: true, checkAge: ["#addSTT input[name='DOB']"] },
...
<asp:Content ID="Content5" ContentPlaceHolderID="FunctionTitle" runat="server">
    <%
        ...
        <%=  CommonFunc.GetCurrentMenu(Request.RawUrl) + Html.ActionLink(canObj.FirstName + " " + canObj.MiddleName + " " + canObj.LastName, "../Interview/Detail/" + canObj.ID)
                                              + " » " + HiringCenterPageInfo.FuncTransferToSTT%>
