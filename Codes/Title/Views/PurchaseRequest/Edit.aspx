...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <%using (Html.BeginForm("Edit", "PurchaseRequest", FormMethod.Post, new { id = "purchaseForm", @class = "form", enctype = "multipart/form-data" }))
      { %>
    <uc1:UCInfo ID="UCInfo1" runat="server" />
    <% } %>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PageTitle" runat="server">
    <%=PurchaseRequestPageInfo.FuncEditPurchaseRequest + CommonPageInfo.AppSepChar + PurchaseRequestPageInfo.ComName + CommonPageInfo.AppSepChar + CommonPageInfo.AppName%>
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="FunctionTitle" runat="server">
    <% PurchaseRequest obj = (PurchaseRequest)ViewData.Model;
       ...
       value = CommonFunc.GetCurrentMenu(Request.RawUrl) + " <a href='/PurchaseRequest/Detail/" + obj.ID + "'>" + Constants.PR_REQUEST_PREFIX + obj.ID + "</a> » " + PurchaseRequestPageInfo.FuncEditPurchaseRequest;
    %>
    <%= value%>
</asp:Content>
