...
namespace HR_STG_Excel_Plugin
{
    public partial class UC_ListViewEx : UserControl
    {
        ...
        public UC_ListViewEx(List<HoSo_DTO> list_HS)
        {
            InitializeComponent();
        ...
        public UC_ListViewEx(string sContent)
        {
            InitializeComponent();
            ...
            list_dto = HoSo_DAO.LayDSHoSo(sContent);
        }
        ...
        {
            listViewEx.Columns.Add("Mã", 0, HorizontalAlignment.Left); //0
        ...
        private void refreshListView()
        {
            ...
            for (int i = 0; i < list_dto.Count; i++)
            {
                ...
                {
                    lvi.SubItems.Add(list_dto[i].MaNhomTrachVu);
                }

                if (listViewEx.Columns[4].Visible)
                {
                    lvi.SubItems.Add(list_dto[i].MaTrachVu);
                }
