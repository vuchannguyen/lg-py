...
namespace Weedon
{
    public partial class UcHoaDon : UserControl
    {
            ...
            string sortColumn, string sortOrder, int page)
        {
            ...
            int total = HoaDonBus.GetCount(text, idUser, idKH, date);
            ...
            List<DTO.HoaDon> list = HoaDonBus.GetList(text, idUser, idKH, date,
        ...
        private bool UpdateDataHoaDon()
        {
            foreach (ListViewItem item in lvThongTin.CheckedItems)
            {
                DTO.HoaDon data = HoaDonBus.GetById(ConvertUtil.ConvertToInt(item.SubItems[2].Text));
