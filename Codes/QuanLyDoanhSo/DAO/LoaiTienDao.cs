...
namespace DAO
{
    public class LoaiTienDao : SQLConnection
    {
        public static IQueryable<LoaiTien> GetQuery(string text)
        {
            var sql = from data in dbContext.LoaiTiens
                      select data;
        ...
        {
            return dbContext.LoaiTiens.Where(p => p.Id == id).FirstOrDefault<LoaiTien>();
        }
