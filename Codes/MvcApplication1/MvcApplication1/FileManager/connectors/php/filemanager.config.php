 ...
 *	Icons settings
 */
// path is the URL to the icons
$config['icons']['path'] = 'images/fileicons/'
// fspath is the filesystem path to the icons
$config['icons']['fspath'] = 'images/fileicons/';
...
// root is the filesystem path to the uploaded files
$config['root'] = $_SERVER['DOCUMENT_ROOT'];
//rooturl is the URL path to the uploaded files
$config['rooturl'] = $_SERVER['DOCUMENT_ROOT'];
